...
namespace SpotifyOverlay
{
    public partial class FullscreenOverlayWindow : Window
    {
        ...
        public FullscreenOverlayWindow(SpotifyMediaService mediaService, int targetFps = 0, RingColorOption ringColor = RingColorOption.Silver)
        {
            InitializeComponent();
        ...
        public void SetRingColor(RingColorOption option)
        {
            ...
            RingColorHelper.ApplyRingColor(DiscOuterRing, option, _currentAccentColor, true);
        }
        ...
        private void UpdateTrackUI(TrackChangedEventArgs e)
        {
            ...
            if (e.AlbumArt != null)
            {
                ...
                BlurredBackgroundImage.Source = e.AlbumArt;
                ...
                {
                    RingColorHelper.ApplyRingColor(DiscOuterRing, _ringColorOption, _currentAccentColor, true);
                }
            }
            else
            {
        ...
        private void UpdateTimelineUI(TimeSpan position, TimeSpan duration)
        {
            ...
            // Total available width for progress line: 460px
